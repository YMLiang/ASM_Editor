...
public class ASMSourceViewerConfiguration extends SourceViewerConfiguration{
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		DefaultDamagerRepairer dr = new DefaultDamagerRepairer(new ASMCodeScanner(provider));
		reconciler.setDamager(dr, IDocument.DEFAULT_CONTENT_TYPE);
		reconciler.setRepairer(dr, IDocument.DEFAULT_CONTENT_TYPE);
		
		dr = new DefaultDamagerRepairer(new SingleTokenScanner(new TextAttribute(provider.getColor(ASMColorProvider.SINGLE_LINE_COMMENT))));
		...
		dr = new DefaultDamagerRepairer(new SingleTokenScanner(new TextAttribute(provider.getColor(ASMColorProvider.STRING))));
